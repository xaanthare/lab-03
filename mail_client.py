...
def get_inbox(recipient: str) -> None:
   ...
   Gets a mail entry for the recipient from the server by making a GET request to the /mail endpoint.
...
def get_sent(sender: str) -> None:
   ...
   Gets a mail entry sent by the recipient from the server by making a GET request to the /mail/inbox endpoint.
...
def get_mail(mail_id: str) -> None:
   ...
   Gets a mail entry with provided mail ID from the server by making a GET request to the /mail/sent endpoint.
  
   Args:
       mail_id (str): The mail ID the mail
...
def delete_mail(mail_id: str) -> None:
   ...
   Deletes a mail entry for the recipient from the server by making a DELETE request to the /mail endpoint.
  
   Args:
       mail_id (str): The mail ID of the mail
